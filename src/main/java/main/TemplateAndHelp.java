...
public class TemplateAndHelp {
	...
	public void help() {
		System.out.println(separator + p0 + separator + p1 + separator + p11
				+ separator + p2 + separator + p3 + separator);
	}
	...
	private final String p0 = "What is it:\n"
			...
			+ "-Write notes into the text file '"
			+ tempName
			+ "'\n"
	...
	private final String p1 = "Basic Usage:\n"
			...
			+ tempName + "' file according to formatting rules\n"
			+ "-Run the '" + scriptName
			+ "' script in order to generate and open pdf";
	...
	public boolean template(int which) {
		...
		System.out.println("Template generated in the file: " + tempName + "\n"
				...
				+ "\t-run the srcipt called '" + scriptName
				+ "' in order to convert "
				+ "in into the LaTeX and generate pdf");
		return true;
	}

	private void writeTemplate(int which) throws Exception {
		// Create file
		...
		case 2:
			...
			break;
		default:
			System.err.println("Error: unrecognized selection of template");
			out.write(temp1);
		}
